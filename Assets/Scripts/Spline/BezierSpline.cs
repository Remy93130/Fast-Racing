...
public class BezierSpline : MonoBehaviour
{
    ...
    public Vector3 GetPoint(float t)
    {
        ...
        return transform.TransformPoint(Beziers.GetPoint(points[i], points[i + 1], points[i + 2], points[i + 3], t));
    }
    ...
    public Vector3 GetVelocity(float t)
    {
        ...
        return transform.TransformPoint(Beziers.GetFirstDerivative(points[i], points[i + 1], points[i + 2], points[i + 3], t)) - transform.position;
    }
